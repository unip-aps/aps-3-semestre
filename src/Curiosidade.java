...
public class Curiosidade {
	...
	public void menuCuriosidades() throws InputMismatchException {
		int op;
		...
		do {
			try {
				...
				switch (op) {
					...
					case 1:
						console.ConsoleTitle("Carro Compacto");
					...
					case 2:
						console.ConsoleTitle("Carro Pick-Up");
					...
					case 3:
						console.ConsoleTitle("Carro Sedan");
					...
					case 4:
						console.ConsoleTitle("Carro Suv");
					...
					case 5:
						console.ConsoleTitle("Carro Esportivo");
